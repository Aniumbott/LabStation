                  ...
                  {pendingBookings.map((booking) => (
                    <TableRow key={booking.id}>
                      ...
                      <TableCell className="text-right space-x-2">
                        <Button variant="outline" size="sm" className="h-8" onClick={() => handleApproveBooking(booking.id)}>
                          <ThumbsUp className="mr-1.5 h-3.5 w-3.5 text-green-600" /> Approve
                        </Button>
                        <Button variant="destructive" size="sm" className="h-8" onClick={() => handleRejectBooking(booking.id)}>
