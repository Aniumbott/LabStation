...
import { Archive, ListChecks, PackagePlus, Edit, Trash2, Filter as FilterIcon, FilterX, Search as SearchIcon, Loader2, X, CheckCircle2, Building, PlusCircle, CalendarOff, Repeat, Wrench, ListFilter, PenToolIcon, AlertCircle, CheckCircle, Globe } from 'lucide-react'; // Added Globe
...
import { addAuditLog, addNotification } from '@/lib/firestore-helpers'; // Added addNotification
...
export default function LabManagementPage() {
  ...
  const [allResourcesForCountsAndChecks, setAllResourcesForCountsAndChecks] = useState<Resource[]>([]); // Combined from allResourcesForTypeCount and allResourcesForMaintenance
  ...
  const [tempClosureLabIdFilter, setTempClosureLabIdFilter] = useState<string>('all'); // For filtering closures by lab
  ...
  return (
    <TooltipProvider>
      <div className="space-y-8">
        <PageHeader title="Lab Management" description="Define labs, resource types, closures, and manage maintenance." icon={Archive} />
