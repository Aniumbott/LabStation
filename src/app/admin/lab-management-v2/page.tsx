...
type ResourceTypeSortableColumn = 'name' | 'resourceCount'; // Removed 'description'
  ...
  const pageHeaderActionsContent = (
    <div className="flex items-center gap-2">
      {activeContextId !== GLOBAL_CONTEXT_VALUE && (
        <Button variant="outline" size="sm" className="h-9" onClick={() => setActiveContextId(GLOBAL_CONTEXT_VALUE)}>
          <ArrowLeft /> System View
        </Button>
      )}
          ...
          {activeContextId === GLOBAL_CONTEXT_VALUE && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 space-y-6">
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    <div><CardTitle className="text-xl flex items-center gap-2"><Wrench className="h-5 w-5 text-primary"/>All Maintenance Requests</CardTitle></div>
                    <div className="flex gap-2">
