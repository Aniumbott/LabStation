                  ...
                  <CardContent className="pt-0">
                    <Tabs defaultValue="specific-dates-global" className="text-sm">
                      ...
                      <TabsContent value="specific-dates-global" className="space-y-2">
                        <Button onClick={handleOpenNewDateDialog} size="sm" className="w-full"><PlusCircle />Date</Button>
                      ...
                      <TabsContent value="recurring-rules-global" className="space-y-2">
                        <Button onClick={handleOpenNewRecurringDialog} size="sm" className="w-full"><PlusCircle />Rule</Button>
                        <ScrollArea className="max-h-60 border rounded-md">
                ...
                <Card>
                 ...
                 <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    <Button variant="outline" size="xs" className="h-7" onClick={() => setIsMaintenanceFilterDialogOpen(true)}><FilterIcon/>Filter</Button>
                  </CardHeader>
                  <CardContent className="p-0">
                      <ScrollArea className="max-h-96 border-t">
                ...
                <div className="lg:col-span-2 space-y-6">
                  <Card>
                    <CardHeader className="flex flex-row items-start justify-between">
                      ...
                      <Button variant="outline" size="sm" onClick={() => handleOpenEditLabDialog(selectedLabDetails)}><Edit />Edit Details</Button>
                    </CardHeader>
                   ...
                   <Card>
                    <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <Button size="sm" onClick={() => setIsManualAddMemberDialogOpen(true)}><Users />Member</Button>
                    </CardHeader>
                    <CardContent className="pt-0">
